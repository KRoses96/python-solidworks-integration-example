...
def open_solidworks_macro():
    ...
    macro_path = os.path.join(parent_dir, "macros", "OPEN_FILE.swp")
...
if __name__ == "__main__":
    ...
    if sld_bool:
        ...
        label = tk.Label(
            root,
            text="O Solidworks vai fechar,\n Grave os ficheiros antes de continuar!",
        )
        ...
        def exit_program():
            ...
            wait_label = tk.Label(
                border_frame,
                text="Porfavor aguarde,\nSolidworks a inicializar",
                fg="white",
                bg="#34495E",
            )
        ...
        no_button = tk.Button(root, text="Cancelar", command=close_window, width=10)
